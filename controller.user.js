    ...
    function connect() {
        ...
        ws.onmessage = m => {
            ...
            if (type == "M") {
                ...
                selectTank();
            } else if (type == "X") { // Signal from server that team scan found target
                HTML.teamFindStatus.textContent = "Joining...";
                HTML.teamFindBtn.disabled = false;
                HTML.stopTeamFindBtn.disabled = true;
            } else if (type == "R") {
                appendTeamFindLog(data[0]);
                HTML.teamFindStatus.textContent = `Hash found [${teamFindHashes.size}]`;
            }
        };
